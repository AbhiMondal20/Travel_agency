	...
	<nav class="main-menu">
		<ul>
			...
			<li class="has-subnav">
				...
				<ul>
					<li>
						<a class="subnav-text" href="summerpackage.php">Summer Package</a>
					</li>
					<li>
						<a class="subnav-text" href="winterpackage.php">Winter Package</a>
					</li>
					<li>
						<a class="subnav-text" href="devotionalpackage.php">Devotional Package</a>
					</li>
					<li>
						<a class="subnav-text" href="monsoonpackage.php">Monsoon Package</a>
					</li>
				</ul>
			</li>
					...
					<div class="panel panel-widget forms-panel" style="width: 720px; border-left-width: 10px; height: 370px; margin-left: 350px; margin-right: 200px;">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									<form action="insertdevotional.php" method="post"> 
										<div class="form-group"> 
											<label for="exampleInputEmail1"><b>Place Name</b></label> 
											<input type="text" name="dname" class="form-control" id="exampleInputEmail1" placeholder="write name" style="width: 600px;"> 
										</div> 
										<div class="form-group"> 
											<label for="exampleInputPassword1"><b>Number of Days</label> 
											<input type="text" name="ddays" class="form-control" id="exampleInputPassword1" placeholder="" style="width: 126px;"> 
										</div> 
										<div class="form-group"> 
											<label for="exampleInputPassword1"><b>Price</label> 
											<input type="text" name="dprice" class="form-control" id="exampleInputPassword1" placeholder="" style="width: 126px;"> 
										</div> 
										<div class="checkbox"> 
