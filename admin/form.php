...
<body class="blurBg-true" style="background-image: url(4497979-white-backgrounds.jpg); background-repeat: ; background-position: center;">>
...
<form class="formoid-solid-blue" style="background-color:#eeeeee;font-size:20px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#030303;max-width:600px;min-width:150px" method="post" action="" enctype="multipart/form-data"> 
	<div class="title"><h2>Destination Details</h2></div>
	
	<div class="element-input"><label class="title"><span class="required"><b>Destination Name</b></span></label>
	<div class="item-cont"><input class="large" type="text" name="name" required="required" placeholder="Enter Name"/><span class="icon-place"></span></div>

	<br>


	<div class="element-input"><label class="title"><span class="required"><b>Description</b></span></label><div class="item-cont"><input class="large" type="text" name="description" required="required" placeholder="Enter description"/><span class="icon-place"></span></div>
	...
	{
		echo "Destinations Successfully Listed<br><br>";
	}
