	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
			<div class="agile-grids">	
				...
				<div class="table-heading" style="transform: translate(-50%,-50%); position: absolute;">
					<h2 style="padding-left: 175%;">Bookings</h2>
				</div>
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h3>Day-to-Day Bookings</h3>
					  <?php
					  include "connection.php";	
					  if(isset($_POST['search']))
					  {
						  ...
						  //echo " $searchkey ";
						  $sql = "SELECT * FROM `userprofile` WHERE `id` LIKE '%$searchkey%'";
					  ...
					  <form method="post" action="">
							<input type="text"  name="search"  class='form-control' placeholder="search bt booking id" value="<?php echo $searchkey; ?>">
