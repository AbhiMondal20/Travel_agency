...
<?php
    ...
    //query
    $sql = "SELECT `cid`, count(*) as number FROM `userprofile` GROUP BY `cid`";
    ...
    {
        $arrlabels .= "'".$row['cid']." ($row[cid])',";   //adding '' to values as it's a string
        $arrdata .= $row['number'].",";        //it has numeric values
    }
