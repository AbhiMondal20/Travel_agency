...
<!-- Start Formoid form-->
<link rel="stylesheet" href="https://formoid.net/forms/87/273132/formoid-solid-blue.css" type="text/css" />
...
<form class="formoid-solid-blue" style="background-color:#eeeeee;font-size:20px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#030303;max-width:600px;min-width:150px" method="post"> <div class="title"><h2>Payment Gateway</h2></div>
	<div class="element-radio"><label class="title"><b>Card Type</b><span class="required"></span></label>		<div class="column column1"><label><input type="radio" name="radio" value="Visa" required="required"/><span>Visa</span></label><label><input type="radio" name="radio" value="Master Card" required="required"/><span>Master Card</span></label><label><input type="radio" name="radio" value="Debit Card" required="required"/><span>Debit Card</span></label><label><input type="radio" name="radio" value="Credit Catrd" required="required"/><span>Credit Catrd</span></label></div><span class="clearfix"></span>
</div>
	<div class="element-input"><label class="title"><span class="required"><b>Card Holder's Name</b></span></label><div class="item-cont"><input class="large" type="text" name="input2" required="required" placeholder="Card Holder's Name"/><span class="icon-place"></span></div></div>
	<div class="element-number"><label class="title"><span class="required"><b> Card Number </b></span></label><div class="item-cont"><input class="large" type="text" min="0" max="16" name="number" required="required" placeholder="Card Number" value=""/><span class="icon-place"></span></div></div>
	<div class="element-date"><label class="title"><span class="required"><b> Expire Date</b></span></label><div class="item-cont"><input class="small" type="date" name="date" required="required" placeholder=""/><span class="icon-place"></span></div></div>
	<div class="element-number"><label class="title"><span class="required"><b> CCV</b></span></label><div class="item-cont"><input class="small" type="text" min="0" max="3" name="number1" required="required" placeholder="CCV" value=""/><span class="icon-place"></span></div></div>
	<div class="element-separator"><hr><h3 class="section-break-title"></h3></div>



<div class="submit"><input type="submit" value="Continue"/></div><div id="formoid-form-footer"><ul id="formoid-links">
            <li><a href="https://formoid.net/?call=forms_abuse&param=273132" target="_self">Report Abuse</a></li>
        </ul><small>Made with <a href="index.php">Free Formoid</a>.<br>
    This form is accessible for you only and will be wiped out in 4 hours.<br>
    <a href="http://formoid.com/full.html">Upgrade to full version</a> to remove these limitations.</small><small></small></div></form><script type="text/javascript" src="https://formoid.net/forms/87/273132/formoid-solid-blue.js"></script>
<!-- Stop Formoid form-->
